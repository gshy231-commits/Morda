...
namespace ARB
{
    public sealed class OkxDexService(IMemoryCache cache, ILogger<OkxDexService> logger) : BackgroundService
    {
        ...
        // API Configuration
        private const string ApiKey = "4b7361c2-4153-4731-9cde-47594e63b352";
        private const string SecretKey = "5C0CD9294180A6423CFF15091CF1E668";
        private const string Passphrase = "Stalker12)";
